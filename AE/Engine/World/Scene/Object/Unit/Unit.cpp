...
SceneNode_Unit::SceneNode_Unit( Engine * engine, SceneManager * scene_manager, SceneBase * parent, const Path & scene_node_path, SceneBase::Type scene_node_type )
	: SceneNode_Object( engine, scene_manager, parent, scene_node_path, scene_node_type )
{
}
